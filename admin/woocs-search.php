                                ...
                                <div class="acfcs__search-form">
                                    ...
                                    <?php if ( count( $countries ) > 1 ) { ?>
                                        <div class="acfcs__search-criteria acfcs__search-criteria--country">
                                            <label for="woocs_country" class="screen-reader-text"><?php echo apply_filters( 'woocs_select_country_label', esc_html__( 'Select a country', 'acf-city-selector' ) ); ?></label>
                                            <select name="woocs_country" id="woocs_country">
                                                <option value="">
                                                    <?php echo apply_filters( 'woocs_select_country_label', esc_html__( 'Select a country', 'acf-city-selector' ) ); ?>
                                                </option>
                                    ...
                                    <div class="acfcs__search-criteria acfcs__search-criteria--state">
                                        <label for="woocs_state" class="screen-reader-text">
                                            <?php echo apply_filters( 'woocs_select_province_state_label', esc_html__( 'Select a province/state', 'acf-city-selector' ) ); ?>
                                        </label>
                                    ...
                                    <div class="acfcs__search-criteria acfcs__search-criteria--search">
                                        <?php echo sprintf( '<label for="woocs_search" class="screen-reader-text">%s</label>', esc_attr__( 'Search term', 'acf-city-selector' ) ); ?>
                                        <input name="woocs_search" id="woocs_search" type="text" value="<?php if ( false != $searched_term ) { echo stripslashes( $searched_term ); } ?>" placeholder="<?php esc_html_e( 'City name', 'acf-city-selector' ); ?>">
                                    </div>

                                    <div class="acfcs__search-criteria acfcs__search-criteria--plus">+</div>

                                    <div class="acfcs__search-criteria acfcs__search-criteria--limit">
                                        <?php echo sprintf( '<label for="woocs_limit" class="screen-reader-text">%s</label>', esc_attr__( 'Limit', 'acf-city-selector' ) ); ?>
                                        <input name="woocs_limit" id="woocs_limit" type="number" value="<?php if ( false != $selected_limit ) { echo $selected_limit; } ?>" placeholder="<?php esc_html_e( 'Limit', 'acf-city-selector' ); ?>">
                                    </div>

                                    <div class="acfcs__search-criteria acfcs__search-criteria--plus">+</div>

                                    <div class="acfcs__search-criteria acfcs__search-criteria--orderby">
                                        <?php echo sprintf( '<label for="woocs_orderby" class="screen-reader-text">%s</label>', esc_attr__( 'Order by', 'acf-city-selector' ) ); ?>
