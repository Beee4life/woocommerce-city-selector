...
<form method="post">
    ...
    <div class="acfcs__process-file">
        <div class="acfcs__process-file-element acfcs__process-file-element--file">
            <?php echo sprintf( '<label for="acfcs_file_name">%s</label>', esc_attr__( 'File', 'woocommerce-city-selector' ) ); ?>
        ...
        <div class="acfcs__process-file-element acfcs__process-file-element--delimiter">
            <?php $delimiters = [ ';', ',', '|' ]; ?>
            <?php echo sprintf( '<label for="acfcs_delimiter">%s</label>', esc_attr__( 'Delimiter', 'woocommerce-city-selector' ) ); ?>
        ...
        <div class="acfcs__process-file-element acfcs__process-file-element--maxlines">
            <?php echo sprintf( '<label for="acfcs_max_lines">%s</label>', esc_attr__( 'Max lines', 'woocommerce-city-selector' ) ); ?>
            <input type="number" name="acfcs_max_lines" id="acfcs_max_lines" />
        </div>
    </div>

    <?php
        echo sprintf( '<input name="acfcs_verify" type="submit" class="button button-primary" value="%s" />', esc_attr__( 'Verify selected file', 'woocommerce-city-selector' ) );
        echo sprintf( '<input name="acfcs_import" type="submit" class="button button-primary" value="%s" />', esc_attr__( 'Import selected file', 'woocommerce-city-selector' ) );
        echo sprintf( '<input name="acfcs_remove" type="submit" class="button button-primary" value="%s" />', esc_attr__( 'Remove selected file', 'woocommerce-city-selector' ) );
    ?>
</form>
