    ...
    <form name="select-preview-file" id="settings-form" action="" method="post">
        <div class="acfcs__process-file">
            <div class="acfcs__process-file-element">
                <?php echo sprintf( '<label for="woocs_file_name">%s</label>', esc_attr__( 'File', 'acf-city-selector' ) ); ?>
            ...
            <div class="acfcs__process-file-element">
                <?php $delimiters = [ ';', ',', '|' ]; ?>
                <?php echo sprintf( '<label for="woocs_delimiter">%s</label>', esc_attr__( 'Delimiter', 'acf-city-selector' ) ); ?>
            ...
            <div class="acfcs__process-file-element">
                <?php echo sprintf( '<label for="woocs_max_lines">%s</label>', esc_attr__( 'Max lines', 'acf-city-selector' ) ); ?>
