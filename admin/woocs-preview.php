                    ...
                    <div class="content">
                        ...
                        <?php } else { ?>
                            <div>
                                ...
                                <?php echo sprintf( __( 'Upload a csv file from your %s.', 'acf-city-selector' ), sprintf( '<a href="%s">%s</a>', esc_url( admin_url( '/admin.php?page=woocs-dashboard' ) ), __( 'dashboard', 'acf-city-selector' ) ) ); ?>
                            </div>
                        <?php } ?>
