...
<form method="post">
    ...
    <br />
    <?php
        echo sprintf( '<input name="acfcs_verify" type="submit" class="button button-primary" value="%s" />', esc_attr__( 'Verify CSV data', 'woocommerce-city-selector' ) );
        echo sprintf( '<input name="acfcs_import" type="submit" class="button button-primary" value="%s" />', esc_attr__( 'Import CSV data', 'woocommerce-city-selector' ) );
    ?>
</form>
