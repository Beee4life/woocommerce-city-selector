<?php
     ...
     * @return JSON Object
     */
    function woocs_get_states_call() {
        ...
        if ( isset( $_POST[ 'country_code' ] ) ) {
            ...
            if ( isset( $country_code ) ) {
                $states_transient = woocs_get_states( $country_code, true, $field );
            }
    ...
    add_action( 'wp_ajax_get_states_call', 'woocs_get_states_call' );
    add_action( 'wp_ajax_nopriv_get_states_call', 'woocs_get_states_call' );
     ...
     * @return JSON Object
     */
    function woocs_get_cities_call() {
        ...
        if ( isset( $_POST[ 'state_code' ] ) ) {
            ...
            $cities_transient = woocs_get_cities( $country_code, $state_code, $field );
    ...
    add_action( 'wp_ajax_get_cities_call', 'woocs_get_cities_call' );
    add_action( 'wp_ajax_nopriv_get_cities_call', 'woocs_get_cities_call' );
